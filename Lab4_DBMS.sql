...
-- Q9 - Create a stored procedure to display the Rating for a Supplier if any along with the Verdict on that rating if any like if rating >4 then “Good Serivce” if rating >2 “Average Service” else “Poor Service”.
DELIMITER //
CREATE PROCEDURE `supplierRatings` ()
BEGIN
select s.supp_id, s.supp_name, r.rat_ratstars,
case
when r.rat_ratstars > 4 then 'Good Serivce'
